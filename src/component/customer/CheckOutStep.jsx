...
export default function CheckoutSteps({ bookingData }) {
  ...
  const { setPaymentMethod: setPaymentMethodContext } = useContext(PaymentContext);

  // Booking date from props
  const bookingDate = bookingData?.bookingDate || new Date().toISOString().split("T")[0];
